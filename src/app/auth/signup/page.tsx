...
export default function SignupPage() {
  ...
  if(done)return(<div className="min-h-screen bg-black flex items-center justify-center px-4"><div className="rounded-[16px] border border-white/5 bg-[var(--surface-1)] p-6 text-center max-w-sm"><Sparkles className="h-8 w-8 text-emerald-400 mx-auto mb-3" /><h1 className="text-lg font-bold text-white">Check your email</h1><p className="mt-1 text-sm text-white/500">Confirmation sent to {email}</p><Link href="/auth/login" className="mt-3 inline-block text-sm text-emerald-400">Back to sign in</Link></div></div>);
